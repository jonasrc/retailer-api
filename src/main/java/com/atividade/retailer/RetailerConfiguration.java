...
public class RetailerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.atividade.retailer.rest"))
    ...
    private ApiInfo apiEndPointsInfo() {
        ...
        return new ApiInfoBuilder().title("REST API para lojista")
                .description("Spring boot REST API para gestão de reposição de produtos de lojistas"
